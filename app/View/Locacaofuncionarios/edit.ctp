...
<?php echo $this->Form->create('Locacaofuncionario'); ?>
	<fieldset>
		<legend><?php echo __('Edit Locacaofuncionario'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Locacaofuncionario.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Locacaofuncionario.id'))); ?></li>

<div class="tiposequips index">
	<h2><?php echo __('Tiposequips'); ?></h2>
	...
	<?php foreach ($tiposequips as $tiposequip): ?>
	<tr>
		<td><?php echo h($tiposequip['Tiposequip']['id']); ?>&nbsp;</td>
		<td><?php echo h($tiposequip['Tiposequip']['tipo']); ?>&nbsp;</td>
		<td><?php echo h($tiposequip['Tiposequip']['created']); ?>&nbsp;</td>
		<td><?php echo h($tiposequip['Tiposequip']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $tiposequip['Tiposequip']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $tiposequip['Tiposequip']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $tiposequip['Tiposequip']['id']), null, __('Are you sure you want to delete # %s?', $tiposequip['Tiposequip']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>

...
<?php echo $this->Form->create('Venda'); ?>
	<fieldset>
		<legend><?php echo __('Edit Venda'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Venda.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Venda.id'))); ?></li>

<div class="vendas index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('valortotal'); ?></th>
			<th><?php echo $this->Paginator->sort('valorfrete'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($venda['Venda']['valortotal']); ?>&nbsp;</td>
		<td><?php echo h($venda['Venda']['valorfrete']); ?>&nbsp;</td>
		<td><?php echo h($venda['Venda']['created']); ?>&nbsp;</td>
		<td><?php echo h($venda['Venda']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $venda['Venda']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $venda['Venda']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $venda['Venda']['id']), null, __('Are you sure you want to delete # %s?', $venda['Venda']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>

...
<?php echo $this->Form->create('Itensloc'); ?>
	<fieldset>
		<legend><?php echo __('Edit Itensloc'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Itensloc.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Itensloc.id'))); ?></li>

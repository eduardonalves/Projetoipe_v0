<div class="veiculomanutes view">
<h2><?php  echo __('Veiculomanute'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($veiculomanute['Veiculomanute']['id']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($veiculomanute['Veiculomanute']['descricao']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Valor'); ?></dt>
		<dd>
			<?php echo h($veiculomanute['Veiculomanute']['valor']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Datainicio'); ?></dt>
		<dd>
			<?php echo h($veiculomanute['Veiculomanute']['datainicio']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Datafim'); ?></dt>
		<dd>
			<?php echo h($veiculomanute['Veiculomanute']['datafim']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($veiculomanute['Veiculomanute']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($veiculomanute['Veiculomanute']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Veiculomanute'), array('action' => 'edit', $veiculomanute['Veiculomanute']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Veiculomanute'), array('action' => 'delete', $veiculomanute['Veiculomanute']['id']), null, __('Are you sure you want to delete # %s?', $veiculomanute['Veiculomanute']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($veiculomanute['Veiculo'])): ?>
	...
	<?php
		$i = 0;
		foreach ($veiculomanute['Veiculo'] as $veiculo): ?>
		<tr>

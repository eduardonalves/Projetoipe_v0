...
<?php echo $this->Form->create('Itemvenda'); ?>
	<fieldset>
		<legend><?php echo __('Edit Itemvenda'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Itemvenda.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Itemvenda.id'))); ?></li>

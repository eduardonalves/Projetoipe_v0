...
<?php echo $this->Form->create('Itensprojetosequipamento'); ?>
	<fieldset>
		<legend><?php echo __('Edit Itensprojetosequipamento'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Itensprojetosequipamento.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Itensprojetosequipamento.id'))); ?></li>

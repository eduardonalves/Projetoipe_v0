...
<?php echo $this->Form->create('Itenslocacaoequipamento'); ?>
	<fieldset>
		<legend><?php echo __('Edit Itenslocacaoequipamento'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Itenslocacaoequipamento.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Itenslocacaoequipamento.id'))); ?></li>

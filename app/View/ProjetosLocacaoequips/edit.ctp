<div class="projetosLocacaoequips form">
<?php echo $this->Form->create('ProjetosLocacaoequip'); ?>
	<fieldset>
		<legend><?php echo __('Edit Projetos Locacaoequip'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProjetosLocacaoequip.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ProjetosLocacaoequip.id'))); ?></li>

<div class="alocacaoequipamentos index">
	<h2><?php echo __('Alocacaoequipamentos'); ?></h2>
	...
	<?php foreach ($alocacaoequipamentos as $alocacaoequipamento): ?>
	<tr>
		<td><?php echo h($alocacaoequipamento['Alocacaoequipamento']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($alocacaoequipamento['Alocacaoequipamento']['data']); ?>&nbsp;</td>
		<td><?php echo h($alocacaoequipamento['Alocacaoequipamento']['created']); ?>&nbsp;</td>
		<td><?php echo h($alocacaoequipamento['Alocacaoequipamento']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $alocacaoequipamento['Alocacaoequipamento']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $alocacaoequipamento['Alocacaoequipamento']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $alocacaoequipamento['Alocacaoequipamento']['id']), null, __('Are you sure you want to delete # %s?', $alocacaoequipamento['Alocacaoequipamento']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>

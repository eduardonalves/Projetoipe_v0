...
<?php echo $this->Form->create('LocacaotiposequipsTiposequip'); ?>
	<fieldset>
		<legend><?php echo __('Edit Locacaotiposequips Tiposequip'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('LocacaotiposequipsTiposequip.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('LocacaotiposequipsTiposequip.id'))); ?></li>

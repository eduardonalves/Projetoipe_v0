<div class="locacaoequipamentosTiposequips index">
	<h2><?php echo __('Locacaoequipamentos Tiposequips'); ?></h2>
	...
	<?php foreach ($locacaoequipamentosTiposequips as $locacaoequipamentosTiposequip): ?>
	<tr>
		<td><?php echo h($locacaoequipamentosTiposequip['LocacaoequipamentosTiposequip']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $locacaoequipamentosTiposequip['LocacaoequipamentosTiposequip']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $locacaoequipamentosTiposequip['LocacaoequipamentosTiposequip']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $locacaoequipamentosTiposequip['LocacaoequipamentosTiposequip']['id']), null, __('Are you sure you want to delete # %s?', $locacaoequipamentosTiposequip['LocacaoequipamentosTiposequip']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>

...
<?php echo $this->Form->create('Rota'); ?>
	<fieldset>
		<legend><?php echo __('Edit Rota'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Rota.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Rota.id'))); ?></li>

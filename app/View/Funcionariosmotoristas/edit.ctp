...
<?php echo $this->Form->create('Funcionariosmotorista'); ?>
	<fieldset>
		<legend><?php echo __('Edit Funcionariosmotorista'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Funcionariosmotorista.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Funcionariosmotorista.id'))); ?></li>
